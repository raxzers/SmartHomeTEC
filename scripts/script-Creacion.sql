...
ALTER TABLE L_DIST
ADD CONSTRAINT L_DIST_ADmin_FK FOREIGN KEY (Ademail)
REFERENCES ADMINISTRADOR(Email);

ALTER TABLE L_DISP_TOTAL
ADD CONSTRAINT L_DISP_TOTAL_ADmin_FK FOREIGN KEY (Ademail)
REFERENCES ADMINISTRADOR(Email);

ALTER TABLE L_DISP_REGION
ADD CONSTRAINT L_DISP_REGION_ADmin_FK FOREIGN KEY (Ademail)
REFERENCES ADMINISTRADOR(Email);
...
ALTER TABLE PEDIDO
ADD CONSTRAINT PEDIDO_CLIENTE_FK FOREIGN KEY (Clemail)
REFERENCES CLIENTE(Email);

ALTER TABLE APOSENTO
ADD CONSTRAINT APOSENTO_CLIENTE_FK FOREIGN KEY (Clemail)
REFERENCES CLIENTE(Email);

ALTER TABLE DISPOSITIVO_APOSENTO
ADD CONSTRAINT DISPOSITIVO_APOSENTO_CLIENTE_FK FOREIGN KEY (Clemail)
REFERENCES CLIENTE(Email);
...
ADD CONSTRAINT TIPODISPOSITIVO_DISPOSITIVO_FK FOREIGN KEY (Dispserie)
REFERENCES DISPOSITIVO(Serie);
